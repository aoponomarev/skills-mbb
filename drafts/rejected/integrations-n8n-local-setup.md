...
tags: [#integrations, #n8n, #docker, #status-update]
...
4. **История миграции**: При возникновении вопросов по структуре томов сверяться с n8n/MIGRATION.md.
5. **Безопасность**: Проверить git status, чтобы убедиться, что runtime-файлы n8n игнорируются.

## References
- docker-compose.yml
- .env (ignore)
- n8n/MIGRATION.md (Migration history and volume details)
...
- dependencies: [skill-secrets-hygiene]
- updated_at: 2026-01-26
- source_refs: ["docker-compose.yml", "BACKLOG.md", "n8n/MIGRATION.md"]
